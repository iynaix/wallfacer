...
in
{
  "@catppuccin/tailwindcss" = nodeEnv.buildNodePackage {
    name = "_at_catppuccin_slash_tailwindcss";
    packageName = "@catppuccin/tailwindcss";
    version = "0.1.6";
    src = fetchurl {
      url = "https://registry.npmjs.org/@catppuccin/tailwindcss/-/tailwindcss-0.1.6.tgz";
      sha512 = "V+Y0AwZ5SSyvOVAcDl7Ng30xy+m82OKnEJ+9+kcZZ7lRyXuZrAb2GScdq9XR3v+ggt8qiZ/G4TvaC9cJ88AAXA==";
    };
    dependencies = [
    ...
    meta = {
      description = "<h3 align=\"center\"> 	<img src=\"https://raw.githubusercontent.com/catppuccin/catppuccin/main/assets/logos/exports/1544x1544_circle.png\" width=\"100\" alt=\"Logo\"/><br/> 	<img src=\"https://raw.githubusercontent.com/catppuccin/catppuccin/main/assets/misc/transp";
      homepage = "https://github.com/catppuccin/tailwindcss#readme";
      license = "MIT";
    };
    production = true;
    bypassCache = true;
